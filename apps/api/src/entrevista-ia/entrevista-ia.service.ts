 ...
 *  - Lectura admin/participante de intento e historial.
 *
 * El cierre (finalizar/ajustar/anular) y recalculo de skills viven en
 * `EntrevistaEvaluacionService` (split Fase 1.1); este service preserva la
 * interfaz publica mediante fachadas que delegan en aquel.
 */
@Injectable()
export class EntrevistaIaService {
  ...
  constructor(
    ...
    private readonly evaluacion: EntrevistaEvaluacionService,
  ) {}
  ...
  // Fachada: delega en EntrevistaEvaluacionService.
  // ===========================================================================
  ...
  finalizar(input: {
    ...
    return this.evaluacion.finalizar(input)
  }
  ...
  ajustar(input: {
    ...
    return this.evaluacion.ajustar(input)
  }
  ...
  anular(input: {
    ...
    return this.evaluacion.anular(input)
  }
