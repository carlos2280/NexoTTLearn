...
import { type FichaResumenResponseDTO, obtenerFichaResumen } from "../api/obtener-ficha-resumen.api"
 ...
 */
export function useFichaResumen(): UseQueryResult<FichaResumenResponseDTO, ApiError> {
  return useQuery<FichaResumenResponseDTO, ApiError>({
