...
export const SEED_MODULOS: ModuloResponse[] = [
  ...
  },
  {
    ...
    descripcion: "HTML semántico, JavaScript moderno y TypeScript práctico.",
    estado: "ACTIVO",
    createdAt: ahora,
    updatedAt: ahora,
  },
  {
    ...
    descripcion: "Servicios y APIs rápidos con Python.",
    estado: "ACTIVO",
    createdAt: ahora,
    updatedAt: ahora,
  },
  {
    id: uuid("mod8"),
    titulo: "DevOps & Cloud",
    descripcion: "Git profesional y despliegues en Azure.",
    estado: "ACTIVO",
    createdAt: ahora,
    updatedAt: ahora,
  },
