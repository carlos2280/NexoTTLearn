...
const TRANSVERSAL_POR_CURSO: ReadonlyMap<string, TransversalResponse> = new Map([
  [
    "curso-java-senior",
    {
      ...
      descripcion:
        "Demuestra que puedes integrar todo lo del curso: arma un servicio REST con Spring Boot, persistencia con JPA y tests unitarios. Subimos el repositorio y nuestro evaluador automatico revisa funcionalidad, calidad y comprension del codigo.",
      umbralAprobacion: 70,
      pesosCapas: { tests: 50, cualitativa: 30, comprension: 20 },
      capasActivas: { tests: true, cualitativa: true, comprension: true },
      skillsQueMide: [],
    },
  ],
  [
    "curso-fullstack-devops",
    {
      ...
      descripcion:
        "Integra todo lo del bootcamp en una aplicacion full-stack desplegable: frontend React, backend Express con base de datos, dockerizada y desplegada en un registry publico. Subimos el repositorio y revisamos el conjunto.",
      umbralAprobacion: 70,
      pesosCapas: { tests: 60, cualitativa: 25, comprension: 15 },
...
function fallbackTransversal(cursoId: string): TransversalResponse {
  return {
    ...
    descripcion:
      "Demuestra que sabes integrar todo lo del curso en un proyecto real. Sube el repositorio y nuestro evaluador automatico revisa tu trabajo.",
    umbralAprobacion: 70,
