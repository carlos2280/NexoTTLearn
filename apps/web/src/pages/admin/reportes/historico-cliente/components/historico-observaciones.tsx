...
interface HistoricoObservacionesProps {
  readonly observaciones: readonly ObservacionFrecuente[]
}

export function HistoricoObservaciones({ observaciones }: HistoricoObservacionesProps) {
    ...
    <Card tono="plano" densidad="generosa" className="flex flex-col gap-6">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-body-sm text-text-secondary">
          Las razones más repetidas detrás de los rechazos del cliente.
        </p>
      </header>
