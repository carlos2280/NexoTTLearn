...
interface CuerpoOpcionUnicaProps {
  ...
  readonly onCambiar: (siguiente: PreguntaOpcionUnica) => void
}

const MAX_OPCIONES = 6

export function CuerpoOpcionUnica({ pregunta, onCambiar }: CuerpoOpcionUnicaProps) {
  ...
  function marcarCorrecta(opcionId: string) {
    onCambiar({
      ...pregunta,
      opciones: pregunta.opciones.map((o) => ({ ...o, esCorrecta: o.id === opcionId })),
    })
  }
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex items-center justify-between">
        <span className="nx-eyebrow text-text-tertiary">Opciones · una correcta</span>
