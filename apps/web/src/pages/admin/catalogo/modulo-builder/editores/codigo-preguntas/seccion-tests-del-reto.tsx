...
import { EditorTestsEmbebido } from "./editor-tests-embebido"
...
/**
 * Sección "Tests automáticos" embebida en el editor del Reto. Encuentra el
 * bloque CODIGO_TESTS pareado (por `contenido.codigoPreguntasId`), lo carga y
  ...
  async function crearTests() {
    await crear.mutateAsync({
      ...
      input: {
        ...
        esEvaluable: false,
        skillQueMideId: null,
        contenido: contenidoPorDefecto("CODIGO_TESTS", { codigoPreguntasHermanoId: reto.id }),
      },
    })
