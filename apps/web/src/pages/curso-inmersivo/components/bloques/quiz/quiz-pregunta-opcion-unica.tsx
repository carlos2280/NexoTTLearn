...
export function QuizPreguntaOpcionUnica({
  ...
  return (
    <fieldset className="flex flex-col gap-2" disabled={bloqueado}>
      ...
      {
        // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: orquesta variantes visuales por estado (intento, solución, acierto/fallo); cada rama es un caso visible.
